                      ...
                      <ul className="space-y-12">
                        <li className="relative flex flex-col items-start">
                          ...
                          <p className="mt-3 text-sm text-zinc-600 dark:text-zinc-400">
                            ...
                            day. I’ve never heard the fans turn on a single time, even under the incredibly heavy loads
                            I put it through with our various launch simulations.
                          </p>
                        </li>
                        ...
                        <li className="relative flex flex-col items-start">
                          ...
                          <p className="mt-3 text-sm text-zinc-600 dark:text-zinc-400">
                            They don’t make keyboards the way they used to. I buy these any time I see them go up for
                            sale and keep them in storage in case I need parts or need to retire my main.
                          </p>
                        </li>
                        ...
                        <li className="relative flex flex-col items-start">
                          ...
                          <p className="mt-3 text-sm text-zinc-600 dark:text-zinc-400">
                            If I’m going to slouch in the worst ergonomic position imaginable all day, I might as well
                            do it in an expensive chair.
                          </p>
                        </li>
                      </ul>
                    </div>
