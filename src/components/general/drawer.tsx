...
>(({ ...props }, ref) => (
  <DrawerPrimitive.Overlay className={'fixed inset-0 z-50 bg-gray-900/10 opacity-100 backdrop-blur-sm'} {...props} ref={ref} />
));
DrawerOverlay.displayName = DrawerPrimitive.Overlay.displayName;

type DrawerContentProps = React.ComponentPropsWithoutRef<typeof DrawerPrimitive.Content>;

const DrawerContent = React.forwardRef<React.ComponentRef<typeof DrawerPrimitive.Content>, DrawerContentProps>(({ children, ...props }, ref) => (
